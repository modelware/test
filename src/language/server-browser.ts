...
import { BrowserMessageReader, BrowserMessageWriter, createConnection, RequestType } from 'vscode-languageserver/browser.js';
...
const { shared } = createOmlServices({ connection, ...BrowserFileSystem(connection) });
